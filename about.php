...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      ...
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">jadi gini ... </p>
          <p class="Teks_Informasi">koe gawe toko larang wae hahaha </p>
          ...
          <p class="Teks_Informasi">Salam Larang wkwk</p></td>
      </tr>
    </table></th>
