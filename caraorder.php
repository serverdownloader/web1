...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      ...
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">Cara berbelanja di webRH sangat mudah. Bacalah petunjuk di bawah ini dan Anda siap untuk berbelanja!</p>
          ...
          <p class="Teks_Informasi">WEBrh</p>
